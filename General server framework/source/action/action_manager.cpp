...
void action_manager::on_connect_action_chain(boost::shared_ptr<message> msg)
{
...
void action_manager::on_disconnect_action_chain(boost::shared_ptr<message> msg)
{
...
void action_manager::on_error_action_chain(boost::shared_ptr<message> msg)
{
...
void action_manager::on_user_define_action_chain(boost::shared_ptr<message> msg)
{
